    ...
    if(theCurrentSend != nil)
    {
        ...
        if([self canAcceptBytes:theSocket])
        {
            ...
            else
            {
                ...
                unsigned int datsi = (unsigned int)dstSize;
                result = sendto(theNativeSocket, buf, bufSize, 0, dst, datsi);
            }
                    ...
                    if(result >= 0)
                    {
                        ...
                        else
                        {
                            ...
                            NSData *data = [[NSData alloc] initWithBytesNoCopy:buf
                                                                        length:result
                                                                  freeWhenDone:YES];
                            theCurrentReceive->buffer = [[NSMutableData alloc] initWithData:data];
